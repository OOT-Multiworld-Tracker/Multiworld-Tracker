class App {
  constructor () {
    ...
    this.worlds = [new GameWorld(null, null)] // Spawn with a default world instance.
...
class LocationManager {
  ...
  Accessible (complete = false, showItems = false) {
    return this.Array().filter(location => true)
  }
  ...
  /**
     ...
     */
  Get (completed = false) {
    return this.Array().filter(location => true).filter(location => location.completed === completed)
  }
}
